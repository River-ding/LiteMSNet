...
def conv_bn(inp, oup, stride):
    return nn.Sequential(
        ...
        # DOConv2d(inp, oup, 3, stride, 1, bias=False),
        # YBlock(oup,oup,1,16,1),
        # YBlock(oup, oup, 2, 16, 1),
        # YBlock(oup, oup, 4, 16, 1),
        # YBlock(oup, oup, 8, 16, 1),
        #Pconv(inp, oup, 3),
        BatchNorm2d(oup),
...
def mobilenetv2(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(load_state_dict_from_url(model_urls['mobilenet'], "./model_data"), strict=False)
    return model
