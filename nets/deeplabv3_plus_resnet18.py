...
from nets.resnet_50_18 import resnet50,resnet18
from nets.blocks import YBlock
# from nets.resnet18 import resnet18,resnet50
...
class DeepLab(nn.Module):
    def __init__(self, num_classes, backbone="resnet18", pretrained=True, downsample_factor=16):
        ...
        if backbone=="xception":
            ...
            #   主干部分    [30,30,320]
            # ----------------------------------#
            self.backbone = Resnet18(downsample_factor, pretrained=pretrained)
            in_channels = 512
        ...
        self.yblock2 = nn.Sequential(
            YBlock(512, 256, 1, 16, 1),
            YBlock(256, 256, 2, 16, 1),
            YBlock(256, 256, 4, 16, 1),
            YBlock(256, 256, 8, 16, 1),
        )
