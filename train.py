...
if __name__ == "__main__":
    ...
    #   读取数据集对应的txt
    #---------------------------#
    with open(os.path.join(VOCdevkit_path, "/home/dell/experiment/DJ_study/deeplabv3-plus-pytorch-main/CamVid/ImageSets/Segmentation/trainval.txt"),"r") as f:
        train_lines = f.readlines()
    with open(os.path.join(VOCdevkit_path, "/home/dell/experiment/DJ_study/deeplabv3-plus-pytorch-main/CamVid/ImageSets/Segmentation/test.txt"),"r") as f:
